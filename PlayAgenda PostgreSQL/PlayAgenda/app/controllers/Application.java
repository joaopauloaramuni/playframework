...
public class Application extends Controller {
	...
	private static Connection abrirConexao() throws SQLException {
		...
		String url = "jdbc:postgresql://ec2-54-227-255-156.compute-1.amazonaws.com:5432/df9o5n3jucq3ae?sslfactory=org.postgresql.ssl.NonValidatingFactory";
		Properties props = new Properties();
		props.setProperty("user", "ggpbjbufntnjbr");
		props.setProperty("password", "n8_4Oj6lXnDQox_bQKTMv4OTHe");
